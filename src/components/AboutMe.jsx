...
const AboutMe = ({ initNeons, setNeonState }) => {
  ...
  return (
    <>
      <div ref={ref}></div>
      <section className="ABOUT-ME lg:mt-16 lg:mb-32 ">
          ...
          <div className="flex lg:flex-row flex-col">
            <div className="flex flex-col lg:w-2/3  md:mx-0  mx-2 lg:mt-0 mt-4 order-2 text-[--cwhite] font-regular   xl:text-2xl md:text-xl  lg:leading-relaxed  font-redhat">
              <p className="  lg:mb-8 mb-4">
                I{"'"}m Héctor, a fullstack developer passionate about all kind
                of graphic arts, games and music.
              </p>
              <p className=" lg:mb-8 mb-4">
